...
{% include audio_player.html filename="assets/audio/ST_CNNNaive_1.mp3" %}<br>
LocalConv 3 layer CNN Model:
{% include audio_player.html filename="assets/audio/ST_CNNLocal_1.mp3" %}<br>
Naive resNet Model:
{% include audio_player.html filename="assets/audio/ST_resNetNaive_1.mp3" %}<br>
LocalConv resNet Model:
{% include audio_player.html filename="assets/audio/ST_resNetLocal_1.mp3" %}<br>
LSTM Model:
{% include audio_player.html filename="assets/audio/ST_LSTM_1.mp3" %}<br>

### Polyphonic Music Generation Result(mp3)
LocalConv 3 layer CNN Model:
{% include audio_player.html filename="assets/audio/MT_CNN_3Layer-1.mp3" %}
LSTM Model:
{% include audio_player.html filename="assets/audio/MT_LSTM512_BachAll-1.mp3" %}
